...
const Apply = () => {
  return (
    <section id='apply' className="bg-[#f9fafbd6] h-auto mt-10 text-black py-10 px-6">
      <h2 className="text-3xl md:text-5xl mt-14 font-bold text-center text-gray-700 mb-14">
    Explore Our Online Graduation and Post Graduation Courses
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:divide-x md:divide-gray-700">
        ...
        <div className="flex-1 px-4 py-8 md:px-10 md:py-12 text-center">
          <h3 className="text-3xl md:text-3xl font-bold text-black mb-4">Undergraduate Courses</h3>
          <p className="mb-6">
        ...
        <div className="flex-1 px-4 py-8 md:px-10 md:py-12 text-center">
          <h3 className="text-3xl md:text-3xl font-bold text-black mb-4">Postgraduate Courses</h3>
          <p className="mb-6">
