    ...
    <nav className="bg-white shadow-lg p-4 fixed w-full h-15 z-[999]">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4 items-center text-sm gap-5 ml-[100px]">
          ...
          <a href="/unversity" className="text-black  relative after:absolute after:left-0 after:-bottom-1 after:w-full after:h-0.5 after:bg-blue-600 after:scale-x-0 after:transition-transform after:duration-300 hover:after:scale-x-100">UNIVERSITY</a>
        ...
        <div className="hidden md:flex space-x-4 items-center text-sm gap-2 mr-5">
          ...
          <a href="https://www.instagram.com/diztoversity?igsh=MTB5amx5NjhwdXc0bQ==" className="text-black"><FaInstagram size={23} /></a>
      ...
      >
        <div className="md:hidden mt-12 mb-5">
          ...
          <a href="/unversity" className="block px-4 py-2 text-black hover:bg-gray-200">UNIVERSITY</a>
