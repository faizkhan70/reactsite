    ...
    <nav className="bg-white shadow-lg p-4 fixed w-full h-15 z-[999]">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-4 items-center text-sm gap-5 ml-[100px]">
          <a href="#hero" className="text-black  font-sans relative after:absolute after:left-0 after:-bottom-1 after:w-full after:h-0.5 after:bg-blue-600 after:scale-x-0 after:transition-transform after:duration-300 hover:after:scale-x-100">HOME</a>
