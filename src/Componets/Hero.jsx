      ...
      >
        <div className="relative z-10">
          <div className="absolute inset-x-0 top-1/2 -z-10 flex -translate-y-1/2 justify-start overflow-hidden">
            <img
              ...
              alt=""
              className="h-screen w-full mt-96"
            />
          </div>
        </div>
        <div className="relative z-20 max-w-full px-8 lg:px-8 mt-28 dm:mt-60 ms:mt-32">
          <div className="text-left">
            ...
            <div className="mt-10 flex items-start justify-start gap-x-14 dm:flex-col">
              ...
              <button className="text-lg md:text-xl dm:mt-10 bg-transparent border rounded-xl border-black text-black py-2 px-4 hover:bg-blue-600 hover:text-white shadow-lg shadow-gray-500">
                Get In Touch
              </button>
            </div>
          </div>
