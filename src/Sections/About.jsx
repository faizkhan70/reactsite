    ...
    const features = [
        {
          ...
          description: 'Distance Duniya, one can enroll in any skill-oriented course without having to worry about the admission year. Plus, the courses are accessible worldwide 24/7, meaning if you are in a  9-5 corporate job, you can still learn and update yourself.',
          icon: 'https://cdn.pixabay.com/photo/2022/08/30/18/14/school-7421663_1280.png',
        },
        {
          id: 2,
          title: 'HERE WE ARE',
          description: 'Distance Duniya makes sure that its students get the best package, learning, and placement. We care for you like your parents do when it comes to education and learning. ',
      ...
      <div className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="font-heading mt-2 text-3xl leading-8 font-semibold tracking-tight dm:text-center text-gray-900 sm:text-4xl">
     we provide you with expert teachers who believe in the Harkness method of
learning.
            </p>
            <p className="mt-4 max-w-2xl text-lg text-gray-500 lg:mx-auto dm:text-center">
...
concept of education and learning            </p>
          </div>
